  ...
  useEffect(() => {
    ...
    return () => {
      window.dispatchEvent(
        new CustomEvent("profile-order-fetched", { detail: null })
      );
    };
  }, []);
  ...
  return (
    <>
      <div>
        ...
        <a href="/orders/products">Open Products List </a>
        <div>
          {isLoading ? (
            <div
              id="loader"
              ...
              return (
                <div style={{ marginTop: "30px" }} key={order.id}>
                  ...
                  <div className="users">
                    ...
                    <div>
                      <div id="detailSection">
                        <label id="fieldOrder">Product:</label>
                        <label id="valueOrder">{order?.title}</label>
                      </div>
                      <div id="detailSection">
